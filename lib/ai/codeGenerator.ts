...
const azure = createAzure({
  resourceName: process.env.AZURE_OPENAI_ENDPOINT!.replace("https://", "").split(".")[0],
...
export async function runPipeline({ prompt, handlers }: { prompt: string; handlers?: PipelineHandlers }) {
